...
async function main() {
  ...
  const projectStateSummarySystem = "You are a project progress summarization bot. You create summaries for projects - showing what you've learned, the errors, and what needs to be done. Note that this IS for a real project, not just a call to generate sample text or filler. Use plain text. Output ONLY the new summary, NOTHNG ELSE.";
